...
// Check file size
if ($_FILES["fileToUploadPost"]["size"] > 500000) {
...
// if everything is ok, try to upload file
    ...
    if (copy($_FILES["fileToUploadPost"]["tmp_name"], $target_dir.$uid.'.'.$imageFileType)) {
        echo "The file ". basename( $_FILES["fileToUploadPost"]["name"]). " has been uploaded.";
        //$get -> setProfilePicture($uid,$target_dir.$uid.'.'.$imageFileType);
    } else {
